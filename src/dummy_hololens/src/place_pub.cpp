...
public:
  dummyHoloLensRegPub()
    : Node("place_position_node")
  {
    publisher_ = this->create_publisher<geometry_msgs::msg::Pose>("place_pose", 10);
...
private:
  void keyboardInputLoop()
  {
    while (rclcpp::ok())
    {
      std::cout << "Enter place x, y, and z coordinates separated by spaces: ";
      double x, y, z;
      std::cin >> x >> y >> z;
