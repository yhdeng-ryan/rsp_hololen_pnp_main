...
public:
  dummyHoloLensRegPub()
    : Node("pick_position_node")
  {
    publisher_ = this->create_publisher<geometry_msgs::msg::Pose>("pick_pose", 10);
...
private:
  void keyboardInputLoop()
  {
    while (rclcpp::ok())
    {
      std::cout << "Enter pick x, y, and z coordinates separated by spaces: ";
      double x, y, z;
      std::cin >> x >> y >> z;
